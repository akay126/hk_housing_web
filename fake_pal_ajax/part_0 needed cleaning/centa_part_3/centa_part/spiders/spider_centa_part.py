...
class CentaPartSpider(Spider):
    ...
    start_urls = ['http://txhist.centadata.com/tfs_centadata/Pih2Sln/TransactionHistory.aspx?type=1&code=SGKEPPGXPE&info=basicinfo&ci=en-us']
    def parse(self, response):
        ...
        for url,dl in zip(request_urls[3621:5430],list_dl[3621:5430]):
            yield Request(url=url, meta = {'dl': dl},callback=self.parse_indv,dont_filter=True)
